  ...
  const handleRequestMobileOtp = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setMessage("Verification OTP sent to your mobile and email.");
        setStep("phone_otp");
      }
    } catch (err) {
      setMessage("Network error while sending verification OTP.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <>
      ...
      <div className="signup-page">
        <div className="signup-card">
          ...
          {/* Step 0: Mobile & Email Input */}
          {step === "phone_input" && (
            <form className="signup-otp-form" onSubmit={handleRequestMobileOtp}>
              <h2>Account verification</h2>
              <p>
                Enter your details to begin. We'll send a verification code to both your 
                mobile number and email address.
              </p>
              <div className="signup-grid" style={{ gap: '15px' }}>
                <div className="field">
          ...
          {step === "phone_otp" && (
            <form className="signup-otp-form" onSubmit={handleVerifyMobileOtp}>
              ...
              <p>
                A verification code has been sent to <strong>+91 {form.mobile}</strong> and <strong>{form.email}</strong>.
              </p>
              <div className="field">
