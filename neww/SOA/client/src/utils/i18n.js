...
export const formLabels = {
  'en-IN': {
    ...
    voicePrompts: {
      country: 'Please say the country name',
      state: 'Please say the state name',
      city: 'Please say the city name',
      area: 'Please say the area or locality name',
  ...
  'ta-IN': {
    ...
    voicePrompts: {
      country: 'நாட்டின் பெயர் சொல்லவும்',
      state: 'மாநிலத்தின் பெயர் சொல்லவும்',
      city: 'நகர பெயர் சொல்லவும்',
      area: 'பகுதியின் பெயர் சொல்லவும்',
  ...
  'hi-IN': {
    ...
    voicePrompts: {
      country: 'कृपया देश का नाम बताएं',
      state: 'कृपया राज्य का नाम बताएं',
      city: 'कृपया शहर का नाम बताएं',
      area: 'कृपया क्षेत्र या इलाके का नाम बताएं',
