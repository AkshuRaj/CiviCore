    ...
    <div className="login-page">
      <div className="login-layout">
        ...
        <aside className="login-left">
          ...
          <div className="login-slide-dots">
            {slides.map((s, i) => (
              <button
                key={s.title}
                className={`login-dot ${i === slideIndex ? "login-dot--active" : ""
                  }`}
        ...
        <main className="login-right">
          ...
          <header className="login-header-text">
            <h1>Sign in to OCMS</h1>
            <p>
              Access your dashboard, register new complaints and track existing
              ones in real time.
            </p>
          </header>
          ...
          <div className="login-card">
            {status.text && (
              <div
                className={`login-status login-status--${status.type || "info"
                  }`}
              >
                {status.text}
              </div>
            ...
            {mode === "password" && (
              <form className="login-form" onSubmit={handlePasswordLogin}>
                ...
                <div className="login-divider department-divider">
                  <span>OR LOGIN AS DEPARTMENT</span>
                </div>

                <div className="login-types-grid">
                  <button
                    type="button"
                    className="login-type-btn"
                    onClick={() => navigate("/head/login")}
                  >
                    Head Login
                  </button>
                  <button
