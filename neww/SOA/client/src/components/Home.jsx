        ...
        <div className="ocms-hero-inner">
          <div className="ocms-hero-text-block">
            ...
            <div className="ocms-hero-role-tags">
              <span className="ocms-hero-role-tag--clickable" onClick={() => navigate("/citizen_login")}>User (Citizen)</span>
              <span className="ocms-hero-role-tag--clickable" onClick={() => navigate("/staff")}>Task Manager</span>
              <span className="ocms-hero-role-tag--clickable" onClick={() => navigate("/head")}>Head</span>
              <span className="ocms-hero-role-tag--clickable" onClick={() => navigate("/employee")}>Employee</span>

              <div className="ocms-admin-group" style={{ display: 'inline-block', position: 'relative' }}>
                <span
                  className={`ocms-hero-role-tag--clickable ${isAdminOpen ? 'active' : ''}`}
                  onClick={() => setIsAdminOpen(!isAdminOpen)}
                  style={{ border: isAdminOpen ? '2px solid #3b82f6' : '' }}
                >
                  Admin {isAdminOpen ? '▲' : '▼'}
                </span>

                {isAdminOpen && (
                  <div className="ocms-admin-dropdown" style={{
                    position: 'absolute',
                    top: '100%',
                    left: '0',
                    ...
                    <span className="ocms-dropdown-item" onClick={() => navigate("/adminlogin")}>Admin Login</span>
                    <span className="ocms-dropdown-item" onClick={() => navigate("/admin/dashboard")}>Dashboard</span>
                    <span className="ocms-dropdown-item" onClick={() => navigate("/admindepartments")}>Departments</span>
                    <span className="ocms-dropdown-item" onClick={() => navigate("/adminservice-type")}>Service Types</span>
                    <span className="ocms-dropdown-item" onClick={() => navigate("/adminskills")}>Skills</span>
                    <span className="ocms-dropdown-item" onClick={() => navigate("/adminpriority")}>Priorities</span>
                    <span className="ocms-dropdown-item" onClick={() => navigate("/admincomplaint-categories")}>Complaint Categories</span>
                    <span className="ocms-dropdown-item" onClick={() => navigate("/admincategory-gallery")}>Category Gallery</span>
                    <span className="ocms-dropdown-item" onClick={() => navigate("/secondary-admin-approvals")}>Secondary Admin Approval</span>
                  </div>
                )}
              </div>
            </div>

            <div className="ocms-hero-role-tags" style={{ marginTop: "0.5rem" }}>
              <span className="ocms-hero-role-tag--clickable" onClick={() => navigate("/head/register")}>Register Head</span>
              <span className="ocms-hero-role-tag--clickable" onClick={() => navigate("/head/register-staff")}>Register Staff</span>
              <span className="ocms-hero-role-tag--clickable" onClick={() => navigate("/employee/register")}>Register Employee</span>
              <span className="ocms-hero-role-tag--clickable" onClick={() => navigate("/head/staff-reports")}>Staff Reports</span>
            </div>
          </div>
